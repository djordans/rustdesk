...
#[no_mangle]
pub extern "system" fn Java_com_afflelou_flutter_1hbb_MainService_onVideoFrameUpdate(
    env: JNIEnv,
    _class: JClass,
    buffer: JObject,
) {
...
#[no_mangle]
pub extern "system" fn Java_com_afflelou_flutter_1hbb_MainService_onAudioFrameUpdate(
    env: JNIEnv,
    _class: JClass,
    buffer: JObject,
) {
...
#[no_mangle]
pub extern "system" fn Java_com_afflelou_flutter_1hbb_MainService_setFrameRawEnable(
    env: JNIEnv,
    _class: JClass,
    name: JString,
    value: jboolean,
...
#[no_mangle]
pub extern "system" fn Java_com_afflelou_flutter_1hbb_MainService_init(
    env: JNIEnv,
    _class: JClass,
    ctx: JObject,
) {
